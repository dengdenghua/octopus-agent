...
- Do not reveal or change major secrets unless the user explicitly stages a
  canon-reviewed scene. Current secret: Mira has been hiding a patient whose body is alive but whose legal identity was overwritten by a Ghost court ruling.
