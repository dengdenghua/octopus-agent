"""``octopus migrate`` — one-click migrate plugins/memory/MCP from other AI tools.
...
def run_migrate(
    *,
    ...
    print("\n— applying (staging into .octopus/imported/) —")
    for plan in plans:
    ...
    if activate:
        ...
        print(
            f"  memory: +{report.memory_added} entries into .octopus/MEMORY.md "
