...
``OCTOPUS_WORKSPACE_KEY`` (a urlsafe-base64 32-byte Fernet key from
...
_LOG = logging.getLogger("octopus.workspace.crypto")
...
_KDF_SALT = b"octopus-workspace-key-v1"
...
def _resolve_key() -> bytes:
    """Return the active Fernet key bytes. Prefers ``OCTOPUS_WORKSPACE_KEY``,
    ...
    env_key = os.environ.get("OCTOPUS_WORKSPACE_KEY")
    if env_key:
