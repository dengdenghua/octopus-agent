...
_LOG = logging.getLogger("octopus.workspace.org_audit")

_ORG_AUDIT_CHAIN_KEY_ID = "org-audit-local-v1"
_ORG_AUDIT_CHAIN_SECRET_ENV = "OCTOPUS_ORG_AUDIT_SECRET"
...
def verify_org_audit_chain(
    *,
    ...
    return {
        "schema": "octopus.org_audit_chain.v1",
        "path": str(chain.path),
        "ok": report.ok,
...
def export_org_audit_bundle(
    *,
    ...
    return {
        "schema": "octopus.org_audit_export.v1",
