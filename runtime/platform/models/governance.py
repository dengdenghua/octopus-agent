...
class Budget:
    ...
    def reserve(self, estimated: CostEntry) -> UUID:
        with trace_stage(
            ...
            span.set_attribute("octopus.budget.tokens_estimated", estimated.tokens)
            span.set_attribute("octopus.budget.usd_estimated", estimated.usd)
            ...
            with self._lock:
                ...
                if new_tokens > self.limits.tokens or new_usd > self.limits.usd:
                    ...
                    span.set_attribute("octopus.budget.exceeded", True)
                ...
                span.set_attribute("octopus.budget.utilization", self.utilization)
