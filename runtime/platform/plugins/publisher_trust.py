...
TRUST_STORE_SCHEMA = "octopus.plugin_publisher_trust_store.v1"
_REPORT_SCHEMA = "octopus.plugin_publisher_trust_report.v1"
...
def rotate_publisher_key(
    ...
    *,
    ...
    return {
        "schema": "octopus.plugin_publisher_key_rotation.v1",
...
def revoke_publisher_key(
    ...
    *,
    ...
    with _LOCK:
        ...
        atomic_write_json(store_path, payload)
    return {
        "schema": "octopus.plugin_publisher_key_revocation.v1",
        "publisher_id": publisher_name,
        "key_id": key_name,
        "status": "revoked",
