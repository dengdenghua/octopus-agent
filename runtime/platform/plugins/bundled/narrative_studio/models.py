...
class NarrativeProject(PersistedModel):
    schema_version: str = "octopus.narrative-studio.project.v2"
...
class CandidateRevision(PersistedModel):
    ...
    schema_version: str = "octopus.narrative-studio.candidate-revision.v1"
    project_id: str
...
class CanonCommit(PersistedModel):
    ...
    schema_version: str = "octopus.narrative-studio.canon-commit.v1"
    id: str
    project_id: str
    review_request_id: str
    target_type: ReviewTargetType
