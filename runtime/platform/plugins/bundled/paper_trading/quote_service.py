...
This module is deliberately a market-data plane, not a second Octopus app.  It
...
class QuoteServiceSettings:
    ...
    secret_file: str = ""
    state_dir: str = "/var/lib/octopus/quote-hub"
    ...
    def from_env(cls, environment: Mapping[str, str] | None = None) -> QuoteServiceSettings:
        ...
        return cls(
            ...
            state_dir=value("QUOTE_HUB_STATE_DIR", "state_dir", "/var/lib/octopus/quote-hub"),
