...
class _SyncConfigurePayload(BaseModel):
    cloud_url: str
    pairing_code: str
    device_name: str = "Octopus Desktop"
...
class MX2025ViewerPlugin(ModulePlugin):
    ...
    def __init__(self) -> None:
        ...
        self.cloud_sync = MXCloudSyncConnector("~/.octopus/data/mx2025_viewer")
    ...
    def on_load(self, ctx: Any) -> None:
        ...
        self.allow_same_origin_third_party_scripts = _configured_enabled(
            ...
            env_name="OCTOPUS_MX2025_ALLOW_SAME_ORIGIN_SCRIPTS",
        )
        requested_bridge = str(
            cfg.get("isolated_bridge_url")
            or os.environ.get("OCTOPUS_MX2025_ISOLATED_BRIDGE_URL", "")
        ).strip()
        ...
        proxy_requested = _configured_enabled(
            cfg,
            "proxy_origin",
            env_name="OCTOPUS_MX2025_PROXY_ORIGIN",
        )
    ...
    def register_routes(self) -> None:
        ...
        # which has no access to Octopus account or control-plane routes.
        if self._authenticated_host:
        ...
        def viewer_page() -> HTMLResponse:
            ...
            replacements = {
                ...
                "__MX_OPEN_URL__": "origin/?octopus_proxy=7#/",
                "__MX_PROXY_PATH__": f"/api/plugins/{self.name}/origin/",
                "__MX_FRAME_SRC__": "origin/?octopus_proxy=7#/",
            }
