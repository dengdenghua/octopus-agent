...
class SkillMarket:
    ...
    # (an unpublished ``octopus-agent/skill-hub`` repo) was dead plumbing and the
    ...
    # by dropping a folder under ~/.octopus/skills; the built-in catalog ships
