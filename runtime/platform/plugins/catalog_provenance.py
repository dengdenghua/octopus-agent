...
CATALOG_SIGNATURE_SCHEMA = "octopus.marketplace_catalog_signature.v1"
CATALOG_SIGNATURE_PAYLOAD_SCHEMA = "octopus.marketplace_catalog_signature_payload.v1"
CATALOG_TRUST_SCHEMA = "octopus.plugin_publisher_trust_store.v1"
...
def verify_marketplace_catalog(
    ...
    *,
    ...
    result: dict[str, Any] = {
        "schema": "octopus.marketplace_catalog_trust.v1",
