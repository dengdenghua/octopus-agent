...
CONNECTOR_MANIFEST_RELATIVE_PATH = Path(".octopus-connector/manifest.json")
CONNECTOR_SIGNATURE_RELATIVE_PATH = Path(".octopus-connector/provenance.json")
CONNECTOR_MANIFEST_SCHEMA = "octopus.connector_package.v1"
...
def load_marketplace_package_manifest(
    ...
    *,
    ...
    requirements = payload.get("octopus") if package_kind == "codex" else payload
...
def verify_marketplace_package_trust(
    ...
    *,
    ...
    result = {
        "schema": "octopus.marketplace_package_trust.v1",
        "plugin_id": plugin_id,
        "kind": package_kind,
