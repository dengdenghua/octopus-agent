...
def perform_factory_reset(
    *,
    ...
    Octopus metadata. It does not delete source directories.
    """
    ...
    if clear_user_install_state:
        ...
        install_state = home / ".octopus" / "agents-installed.json"
...
def _project_runtime_paths(root: Path) -> tuple[Path, ...]:
    return (
        root / "data",
        root / ".octopus",
        root / ".octopus-backend.stdout.log",
        root / ".octopus-backend.stderr.log",
