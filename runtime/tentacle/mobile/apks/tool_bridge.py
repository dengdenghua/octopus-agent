...
Octopus Mobile 端用 Kotlin 重写（``../octopus-mobile/app/src/main/java/com/apk/claw/android/octopus_mobile/Protocol.kt``）。
...
class ErrorCode(int, Enum):
    """JSON-RPC 2.0 + Octopus Mobile 扩展错误码."""
...
class Envelope:
    """JSON-RPC 2.0 envelope (Octopus Mobile 扩展).
