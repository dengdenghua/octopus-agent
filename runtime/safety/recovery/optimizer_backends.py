"""Pluggable prompt-optimizer backends for Octopus evolution.
...
class NativeGepaBackend:
    name = "native_gepa"
    description = "Octopus native Pareto/reflection GEPA-style optimizer."
...
class DspyGepaBackend:
    ...
    def optimize(self, context: OptimizerRunContext) -> Any:
        ...
        raise NotImplementedError(
            "dspy_gepa backend is registered but no Octopus->DSPy Program "
