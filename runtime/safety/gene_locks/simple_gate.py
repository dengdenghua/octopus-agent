...
``OCTOPUS_GENE_LOCKS_MODE=production`` flips the gate into
...
_LOG = logging.getLogger("octopus.gene_locks")
...
def _load() -> LockState:
    ...
    with _STATE_LOCK:
        ...
        if not path.is_file():
            ...
            # the default by setting ``OCTOPUS_GENE_LOCKS_MODE``.
            env_mode = os.environ.get("OCTOPUS_GENE_LOCKS_MODE", "").lower()
