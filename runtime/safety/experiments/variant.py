...
class ABSplitter:
    ...
    def next_variant(self) -> Variant:
        with trace_stage("camouflage.assign") as span:
            ...
            span.set_attribute("octopus.camouflage.variant", v.name)
            span.set_attribute("octopus.camouflage.mode", "random")
            return v
    ...
    def assign_for(self, key: str | bytes) -> Variant:
        ...
        with trace_stage("camouflage.assign") as span:
            self._record_assignment(v.name)
            span.set_attribute("octopus.camouflage.variant", v.name)
            span.set_attribute("octopus.camouflage.mode", "sticky")
