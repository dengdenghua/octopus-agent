    ...
    def propose(
        ...
        *,
        ...
        with trace_stage("camouflage.prompt_mutator.propose") as span:
            ...
            if not new_suffix:
                span.set_attribute("octopus.mutator.parse", "no_suffix_tag")
                return None
            ...
            if suffix_hash in self._seen_hashes:
                span.set_attribute("octopus.mutator.skip", "duplicate_suffix")
                return None
            if suffix_hash == _hash(base.system_prompt_suffix):
                span.set_attribute("octopus.mutator.skip", "no_change_from_base")
                return None
            ...
            span.set_attribute("octopus.mutator.new_variant", new_name)
            span.set_attribute("octopus.mutator.suffix_chars", len(new_suffix))
    ...
    def propose_merge(
        ...
        *,
        ...
        with trace_stage("camouflage.prompt_mutator.merge") as span:
            span.set_attribute("octopus.mutator.parent_a", parent_a.name)
            span.set_attribute("octopus.mutator.parent_b", parent_b.name)

            if parent_a.name == parent_b.name:
                span.set_attribute("octopus.mutator.skip", "same_parent")
                return None
            a_suffix = parent_a.system_prompt_suffix
            b_suffix = parent_b.system_prompt_suffix
            if a_suffix == b_suffix:
                span.set_attribute("octopus.mutator.skip", "parents_identical")
                return None
            ...
            if merged_hash == _hash(a_suffix) or merged_hash == _hash(b_suffix):
                span.set_attribute("octopus.mutator.skip", "same_as_parent")
                return None
            ...
            span.set_attribute("octopus.mutator.new_variant", new_name)
            span.set_attribute("octopus.mutator.merged_chars", len(merged))
            return MutationProposal(
                variant=new_variant,
