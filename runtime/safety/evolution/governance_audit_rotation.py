...
_CONFIG_SCHEMA = "octopus.governance_audit_rotation_config.v1"
_STATUS_SCHEMA = "octopus.governance_audit_rotation_status.v1"
_RUN_SCHEMA = "octopus.governance_audit_rotation_run.v1"
_DEFAULT_CRON = "0 2 * * *"
...
def configure_governance_audit_rotation(
    *,
    ...
    append_governance_audit_event(
        ...
        decision_context={
            "schema": "octopus.governance_audit_rotation_config_context.v1",
...
def run_due_governance_audit_rotation(
    *,
    ...
    receipt = append_governance_audit_event(
        ...
        decision_context={
            "schema": "octopus.governance_audit_rotation_run_context.v1",
