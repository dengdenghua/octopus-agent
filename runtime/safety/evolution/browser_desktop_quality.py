...
CHECKS: tuple[BrowserDesktopCheck, ...] = (
    ...
    BrowserDesktopCheck(
        ...
        paths=(
            ...
            "extensions/octopus-browser-relay/sidepanel.html",
            "extensions/octopus-browser-relay/sidepanel.css",
            "extensions/octopus-browser-relay/sidepanel.js",
            "frontend/src/components/workspace/chat-input-box.tsx",
            "tests/test_input_mentions.py",
            "tests/test_realtime_native_tool_loop.py",
            "tests/test_tool_intent_heuristic.py",
        ...
        required_terms=(
            ...
            "request.params",
            "octopus.browser_relay_control.v1",
            "octopus.browser_relay_tab_lease.v1",
            "human_interrupt",
            "octopus.control",
            "octopus.useractivity",
            "octopus.controlindicator",
            "octopus-browser-control-indicator",
            "pointer-events: none",
    ...
    BrowserDesktopCheck(
        ...
        required_terms=(
            ...
            "octopus.computer_screenshot_path_contract.v1",
