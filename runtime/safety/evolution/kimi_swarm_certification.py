...
KIMI_REFERENCE = {
    "schema": "octopus.kimi_swarm_reference.v1",
...
CHECKS: tuple[KimiSwarmEvidenceCheck, ...] = (
    ...
    KimiSwarmEvidenceCheck(
        ...
        required_terms=(
            "octopus.group_fanout_synthesis.v1",
    ...
    KimiSwarmEvidenceCheck(
        ...
        required_terms=(
            "octopus.control_session_replay_timeline.v1",
            "after_cursor",
            "next_cursor",
            "has_more",
    ...
    KimiSwarmEvidenceCheck(
        ...
        required_terms=(
            "octopus.control_evidence_blob_ref.v1",
            "octopus.control_evidence_detail.v1",
    ...
    KimiSwarmEvidenceCheck(
        ...
        required_terms=(
            ...
            "octopus.swarm_replay_package.v1",
    ...
    KimiSwarmEvidenceCheck(
        ...
        required_terms=(
            ...
            "max_concurrency",
            "test_full_scale_mode_dispatches_kimi_scale_roster_with_bounded_workers",
            "octopus.kimi_swarm_load_test.v1",
            "provider_backed",
            "confirm_real_provider",
            "max_provider_calls",
            "estimated_max_tokens",
            "octopus.kimi_swarm_load_test_preflight.v1",
            "octopus.kimi_swarm_load_stage_plan.v1",
            ...
            "record_every_step",
            "octopus.kimi_swarm_proof_bundle.v1",
            "export_kimi_swarm_proof_bundle",
            "timeline_digest",
            ...
            "octopus.kimi_swarm_failure_summary.v1",
            "provider_quota_limit",
            "provider_rate_limit",
            "provider_rate_limited",
            "latest_blocking_failure",
            "octopus.kimi_swarm_stage_blocking_failure.v1",
            ...
            "octopus.kimi_swarm_quota_probe.v1",
            ...
            "octopus.kimi_swarm_composite_proof.v1",
            "octopus.kimi_swarm_composite_coverage.v1",
...
def compute_kimi_swarm_certification(
    *,
    ...
    if ready and load_test_ready:
        ...
        verdict = "needs_work"
    return {
        "schema": "octopus.kimi_swarm_certification.v1",
        ...
        "total": len(checks),
        "summary": {
            "octopus_deterministic_max_members": 320,
            "octopus_worker_concurrency_proven": 32,
