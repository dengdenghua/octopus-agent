...
DIMENSIONS: tuple[AutomationRadarDimension, ...] = (
    AutomationRadarDimension(
        ...
        scores={"codex": 98, "claude_code": 88, "cursor": 82, "octopus": 99},
        evidence_check_ids=(
    ...
    AutomationRadarDimension(
        ...
        scores={"codex": 88, "claude_code": 82, "cursor": 76, "octopus": 95},
        evidence_check_ids=("browser_pixel_replay_gate",),
        next_actions=(
    ...
    AutomationRadarDimension(
        ...
        scores={"codex": 93, "claude_code": 86, "cursor": 83, "octopus": 95},
    ...
    AutomationRadarDimension(
        ...
        scores={"codex": 95, "claude_code": 91, "cursor": 84, "octopus": 96},
        evidence_check_ids=(
            "browser_session_lifecycle",
    ...
    AutomationRadarDimension(
        ...
        scores={"codex": 92, "claude_code": 84, "cursor": 80, "octopus": 95},
        evidence_check_ids=(
            "browser_session_lifecycle",
            "desktop_preview_execute_lease",
            "operator_visibility",
...
def compute_automation_radar(
    *,
    ...
    gaps = [
        ...
        or row["scores"]["octopus"] < row["scores"]["codex"]
...
def _dimension_row(
    ...
    *,
    ...
    return {
        ...
        "octopus_gap_to_target": max(0, target_score - scores["octopus"]),
        "octopus_gap_to_codex": scores["codex"] - scores["octopus"],
        ...
        "operator_drilldown": {
            "schema": "octopus.automation_radar_drilldown.v1",
...
def _next_focus(gaps: list[dict[str, Any]]) -> list[str]:
    ...
    for row in sorted(
        gaps,
        key=lambda item: (
            int(item.get("octopus_gap_to_target") or 0),
...
def _automation_policy_rule_coverage_summary() -> dict[str, Any]:
    try:
        ...
        return {
            "schema": "octopus.automation_policy_rule_coverage.v1",
            "ready": False,
            "total": 0,
            "verified": 0,
