...
_LOG = logging.getLogger("octopus.evolution.runtime_outcomes")
_SCHEMA = "octopus.evolution.runtime_outcomes.v1"
...
def _turn_key(turn_id: str) -> str:
    ...
    return hashlib.sha256(
        b"octopus.evolution.runtime-outcome.turn.v1\0" + resolved.encode("utf-8")
    ).hexdigest()
