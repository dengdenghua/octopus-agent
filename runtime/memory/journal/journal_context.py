...
_TENANT_ID: ContextVar[str | None] = ContextVar("octopus_journal_tenant_id", default=None)
_OWNER_ACTOR_ID: ContextVar[str | None] = ContextVar("octopus_journal_owner_actor_id", default=None)
