...
def _task_run_review_from_loop_checkpoint(
    ...
    for index, item in enumerate(attempt_rows, start=1):
        ...
        if verifier_raw:
            ...
            verifier_result = VerifierResult(
                profile=_clean_str(verifier_raw.get("profile")) or "python_repo_patch",
    ...
    if attempts and attempts[-1].verifier_result is not None:
        ...
        last_verifier_result = VerifierResult(
            profile=_clean_str(last_verifier_raw.get("profile")) or "python_repo_patch",
            ...
            findings=[
                VerifierFinding(name=name, passed=False)
