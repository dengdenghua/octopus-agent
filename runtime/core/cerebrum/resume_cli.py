...
_LOG = logging.getLogger("octopus.resume_cli")
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Defaults to the OCTOPUS_CHECKPOINT_MIRROR_URL env var when "
...
def _resolve_mirror_url(args: argparse.Namespace) -> str | None:
    ...
    if explicit:
        return explicit
    env_url = (os.environ.get("OCTOPUS_CHECKPOINT_MIRROR_URL") or "").strip()
