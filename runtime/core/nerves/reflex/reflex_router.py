    ...
    def try_match(self, intent: ParsedIntent) -> ReflexMatch | ReflexMiss:
        ...
        with trace_stage("spinal_cord.try_reflex") as span:
            if self._force_deliberative(intent):
                span.set_attribute("octopus.reflex.force_deliberative", True)
            ...
            for reflex in self._reflexes:
                ...
                span.set_attribute("octopus.reflex.rule_id", match.rule_id)
                span.set_attribute("octopus.reflex.kind", match.kind)
                span.set_attribute("octopus.reflex.confidence", match.confidence)
                return match
