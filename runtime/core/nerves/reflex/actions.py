...
_LOG = logging.getLogger("octopus.reflex.action")
...
def _run_mqtt(rule_id: str, cfg: dict[str, Any]) -> ActionResult:
    ...
    Schema::
        ...
        mqtt:
          ...
          client_id: octopus-reflex       # optional, auto-generated
          username: ...                   # optional
          password: ...                   # optional
    ...
    client_id = str(cfg.get("client_id") or f"octopus-reflex-{rule_id}")
