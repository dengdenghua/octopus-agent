...
Usage::
    ...
    octopus guard-health                    # Show overall health
    octopus guard-health --top 10           # Top 10 by hits
    octopus guard-health --noisy            # Show low-precision guards
    octopus guard-health --unjudged         # Show unjudged high-frequency guards
    octopus guard-health --recommend        # Recommend actions

Examples::

    # Daily operator check
    octopus guard-health --noisy

    # Before tuning session
    octopus guard-health --recommend

    # After running judge batch
    octopus guard-health --unjudged
"""
...
def run_guard_health(
    ...
    """Entrypoint for octopus-agent CLI dispatcher."""
