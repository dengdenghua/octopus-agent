...
def register_reach_skills(registry: SkillRegistry) -> int:
    registry.register(
        Skill(
            ...
            description=(
                "Schedule recurring platform_collect runs in Octopus' existing cron store. "
    ...
    registry.register(
        Skill(
            ...
            description=(
                ...
                "JSON or Markdown under ~/.octopus/data/reach/collections by default. Args: "
    ...
    registry.register(
        Skill(
            ...
            summary="Search a specific internet platform through native Octopus routes.",
            description=(
                "Search one platform through Octopus native adapters. Platforms: web, github, "
