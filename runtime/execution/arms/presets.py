...
_OCTOPUS_SOUL = """You are a general-purpose assistant. \
...
def make_mobile_operator_arm(runtime: GraphRuntime) -> Worker:
    ...
    与 desktop_operator_arm 并列，是 Octopus Mobile 的核心 Arm。
    通过 Tentacle 抽象（runtime/tentacle/mobile.py）连接 Octopus Mobile 客户端。
