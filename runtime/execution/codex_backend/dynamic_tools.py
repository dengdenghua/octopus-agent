"""Codex transport compatibility for the shared Echo tool broker."""
...
from .tool_limits import MAX_DYNAMIC_TOOLS


class CodexDynamicToolBroker(HostToolBroker):
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, max_tools=MAX_DYNAMIC_TOOLS, **kwargs)
