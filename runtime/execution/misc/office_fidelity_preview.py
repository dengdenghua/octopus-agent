...
_CACHE_ROOT = Path(tempfile.gettempdir()) / "octopus-office-fidelity-cache"
...
def _render_quicklook_preview(
    ...
    responsive_style = (
        '<style id="octopus-office-fidelity">'
...
def _find_pdftoppm() -> str | None:
    configured = os.environ.get("OCTOPUS_PDFTOPPM_PATH", "").strip()
...
def _find_qlmanage() -> str | None:
    configured = os.environ.get("OCTOPUS_QLMANAGE_PATH", "").strip()
