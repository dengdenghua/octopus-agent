...
LOCAL_PARTNER_SPECS: dict[str, dict[str, Any]] = {
    ...
    "opencode-cli": {
        "id": "opencode-cli",
        "agent_id": "local_opencode_cli",
        "name": "OpenCode CLI",
        "default_alias": "OpenCode CLI 伙伴",
        ...
        "tool_groups": ["web_read", "fs_writer", "git", "shell"],
        "tags": ["local", "partner", "coding", "opencode"],
        "icon": "OC",
    },
    "hermes": {
        "id": "hermes",
        ...
        "name": "Hermes Agent",
        "default_alias": "Hermes Agent 伙伴",
        "description": "检测本机 Hermes Agent，注册为可被团队指派的本地工程伙伴。",
        "commands": [
            "hermes",
            "hermes-agent",
            "hermes-cli",
        ...
        "tool_groups": ["web_read", "fs_writer", "git", "shell"],
        "tags": ["local", "partner", "coding", "hermes"],
        "icon": "HR",
    },
    "codebuddy-cli": {
        "id": "codebuddy-cli",
