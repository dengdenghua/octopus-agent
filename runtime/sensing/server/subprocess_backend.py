    ...
    def sandbox(self, arm_id: str) -> Iterator[SubprocessSandbox]:
        with trace_stage("backend.subprocess.sandbox", arm_id=arm_id) as span:
            ...
            try:
                ...
                span.set_attribute("octopus.backend.subprocess_calls", box.subprocess_call_count)
    ...
    def run_skill(self, skill_name: str, args: dict[str, Any]) -> dict[str, Any]:
        ...
        with trace_stage(
            ...
            **{"octopus.skill.name": skill_name},
            ...
            span.set_attribute("octopus.backend.exit_code", proc.returncode)
