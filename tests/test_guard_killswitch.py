...
* ``OCTOPUS_DISABLED_GUARDS`` env var — runtime knob the ReAct loop
...
# ══════════════════════════════════════════════════════════════════
# OCTOPUS_DISABLED_GUARDS env var
# ══════════════════════════════════════════════════════════════════
...
class TestEnvVarParsing:
    ...
    def test_blank_returns_empty(self, monkeypatch: pytest.MonkeyPatch) -> None:
        monkeypatch.setenv("OCTOPUS_DISABLED_GUARDS", "   ")
        assert _disabled_guard_labels() == frozenset()

    def test_single_label(self, monkeypatch: pytest.MonkeyPatch) -> None:
        monkeypatch.setenv("OCTOPUS_DISABLED_GUARDS", "magic-number guard")
    ...
    def test_re_read_on_each_call(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setenv("OCTOPUS_DISABLED_GUARDS", "guard-b")
