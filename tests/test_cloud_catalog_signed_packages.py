...
def _package(
    ...
    *,
    ...
    if kind == "codex":
        ...
        if requirements:
            manifest_payload["octopus"] = requirements
    else:
...
def _catalog(
    ...
    *,
    ...
    if trust_store is not None:
        monkeypatch.setenv("OCTOPUS_PLUGIN_PUBLISHER_TRUST_STORE", str(trust_store))
    else:
        monkeypatch.setenv("OCTOPUS_PLUGIN_PUBLISHER_TRUST_STORE", str(tmp_path / "missing.json"))
