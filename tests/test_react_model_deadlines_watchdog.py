...
def test_reasoning_only_watchdog_is_reserved_for_post_tool_rounds() -> None:
    ...
    assert _reasoning_only_watchdog_s(has_tool_evidence=True, recovery=False) == 45.0
    assert _reasoning_only_watchdog_s(has_tool_evidence=True, recovery=True) == 30.0
