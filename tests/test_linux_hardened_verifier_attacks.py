...
_OPT_IN_ENV = "OCTOPUS_RUN_HARDENED_VERIFIER_ATTACKS"
_ATTESTATION_ENV = "OCTOPUS_HARDENED_VERIFIER_RUNNER"
...
def _assert_bounded_result(
    ...
    assert evidence["schema"] == "octopus.hardened_verifier_run.v2"
