...
Opt-in (``OCTOPUS_TTFT_LIVE_SMOKE=1``) because it boots a full server
...
CONFIG = Path(os.environ.get("OCTOPUS_TTFT_SMOKE_CONFIG", "config.local.yaml"))
MODEL = os.environ.get("OCTOPUS_TTFT_SMOKE_MODEL", "kimi-k3")
