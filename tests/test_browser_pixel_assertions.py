...
def test_browser_pixel_failure_becomes_replay_gate_case() -> None:
    ...
    assert case["schema"] == "octopus.browser_pixel_replay_gate_case.v1"
...
def test_browser_pixel_success_does_not_create_replay_gate_case() -> None:
    case = browser_pixel_replay_gate_case(
        ...
        assertion={"schema": "octopus.browser_pixel_assertion.v1", "ok": True},
        comparison={"schema": "octopus.browser_pixel_comparison.v1", "ok": True},
    )
