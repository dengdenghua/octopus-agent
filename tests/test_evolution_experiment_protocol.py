...
def test_evolution_api_exposes_controlled_evidence_and_typed_candidates(
    ...
    ExperimentStore(data_dir / "evolution_experiments.jsonl").append(_trial("octopus"))
    ...
    assert evidence["schema"] == "octopus.evolution.pair_evidence.v1"
