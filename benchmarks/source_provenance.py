...
Octopus server loaded those bytes; callers must record server provenance
...
FILE_DIGEST_SCHEMA = "octopus.source_file_digest.v1"
FILE_DIGEST_VERSION = 1
SOURCE_MANIFEST_SCHEMA = "octopus.source_manifest.v1"
SOURCE_MANIFEST_VERSION = 1
ENGINE_COMPARISON_SOURCE_RULE = "octopus.engine_comparison_source_inputs.v1"
EXPLICIT_SOURCE_RULE = "octopus.explicit_source_inputs.v1"
...
class SourceManifest:
    ...
    def subtree_sha256(self, relative_directory: str | Path) -> str:
        ...
        payload = {
            "schema": "octopus.source_subtree.v1",
            "version": 1,
            "path": prefix,
            "files": rows,
        }
