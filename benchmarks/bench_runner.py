...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--prompt",
        default="Reply with exactly OCTOPUS_EVAL_OK and no other text.",
    )
    parser.add_argument("--expected", default="OCTOPUS_EVAL_OK")
    parser.add_argument("--k", type=int, default=3)
    parser.add_argument("--model", default=None)
    parser.add_argument("--token-env", default="OCTOPUS_API_TOKEN")
