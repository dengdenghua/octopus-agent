...
FULL_CHAIN_SMOKE_SCHEMA = "octopus.hardened_verifier_full_chain_smoke.v1"
...
def run_hardened_verifier_full_chain_smoke(repo_root: str | Path) -> dict[str, Any]:
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(prefix="octopus-hardened-verifier-smoke-") as temporary:
