"""octopus-runtime CLI:`python -m octopus_runtime <list|sync> ...`。
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(prog="octopus_runtime", description="octopus-runtime 资产消费端(registry → 落地)")
    ...
    if not a.slugs:
        ap.error("sync 需要至少一个 slug(如:python -m octopus_runtime sync brainstorming)")
