...
const octopusMaskUrl = `${import.meta.env.BASE_URL}images/octopus.svg`;
  ...
  return (
    ...
    >
      ...
      <FlickeringGrid
        ...
        style={{
          maskImage: `url(${octopusMaskUrl})`,
          WebkitMaskImage: `url(${octopusMaskUrl})`,
        }}
        squareSize={4}
        gridGap={4}
        color={"white"}
      ...
      <div className="container-md relative z-10 mx-auto flex h-screen flex-col items-center justify-center">
        ...
        <h1 className="flex items-center gap-2 text-4xl font-bold md:text-6xl">
          ...
          />{" "}
          <div className="text-white/90">{t.hero.withOctopus}</div>
        </h1>
        ...
        <div className="mt-8 flex items-center gap-4">
          ...
          <a
            ...
            className="flex items-center gap-2 border border-white/10 bg-white/5 px-5 py-2.5 text-sm font-medium text-white/70 backdrop-blur-sm transition-all hover:border-white/20 hover:bg-white/10 hover:text-white"
          >
