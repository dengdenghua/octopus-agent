...
const CACHE_KEY = "octopus.community.feed.v1";
...
const USER_COMMENTS_KEY = "octopus.community.user-comments.v1";
...
/** 已复刻帖子 id 持久化 key。 */
const FORKED_KEY = "octopus.community.forked.v1";
...
const FOLLOWING_KEY = "octopus.community.following.v1";
...
const PUBLISHED_KEY = "octopus.community.published.v1";
...
export async function fetchCommunityFeed(
  ...
  let remoteBase = "";
  try {
    remoteBase = window.localStorage.getItem("octopus.squareBaseUrl") ?? "";
  } catch {
    /* ignore */
  }
