...
// displays browser notifications when background workflows finish. The DSH
// "settlement" analog — keeps users informed when orchestrated work completes
// while they're in another tab or workspace.
