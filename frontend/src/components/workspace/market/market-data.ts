...
const SEED_ITEMS: MarketItem[] = [
  {
    ...
    price: 20,
    cover: "/community/price-watch(1).jpg",
    category: "shopping",
    seller: "省钱 Bot",
    sellerInitial: "省",
    sellerColor: "#00C6FF",
  ...
  },
  {
    ...
    price: 15,
    cover: "/community/weekly-report(1).jpg",
    category: "work",
    seller: "打工侠",
    sellerInitial: "打",
    sellerColor: "#FC466B",
  ...
  },
  {
    ...
    price: 10,
    cover: "/community/language-coach.jpg",
    category: "study",
    seller: "语言教练",
    sellerInitial: "语",
    sellerColor: "#71B280",
  ...
  },
  {
    ...
    price: 30,
    cover: "/community/game-auto-daily.jpg",
    category: "game",
    seller: "游戏管家",
    sellerInitial: "游",
    sellerColor: "#5B8C5A",
  ...
  },
  {
    ...
    price: 14,
    cover: "/community/meeting-notes.jpg",
    category: "work",
    seller: "会议小助手",
    sellerInitial: "会",
    sellerColor: "#3F5EFB",
  ...
  },
  {
    ...
    price: 5,
    cover: "/community/plan-tomorrow.jpg",
    category: "life",
    seller: "清早计划",
    sellerInitial: "清",
    sellerColor: "#FF6A5B",
...
const SOLD_KEY = "octopus.market.sold.v1";
const MINE_KEY = "octopus.market.mine.v1";
