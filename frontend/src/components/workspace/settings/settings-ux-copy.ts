...
const COPY: Record<Locale, SettingsUxCopy> = {
  "zh-CN": {
    ...
    privacy: {
      ...
      advancedEnvironment: "启动时关闭：设置 OCTOPUS_IDENTITY_LOCK=0。",
    ...
    mcp: {
      title: "MCP 服务",
      description: "连接外部工具服务，让 Octopus 在获得你的信任后使用其能力。",
      loading: "正在读取 MCP 服务…",
  ...
  "en-US": {
    ...
    privacy: {
      ...
      advancedEnvironment: "At startup: set OCTOPUS_IDENTITY_LOCK=0.",
  ...
  "ja-JP": {
    ...
    privacy: {
      ...
      advancedEnvironment: "起動時：OCTOPUS_IDENTITY_LOCK=0 を設定。",
  ...
  "ko-KR": {
    ...
    privacy: {
      ...
      advancedEnvironment: "시작 시: OCTOPUS_IDENTITY_LOCK=0 설정.",
