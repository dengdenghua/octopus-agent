/**
 * About Octopus markdown content. Inlined to avoid raw-loader dependency
 * (Turbopack cannot resolve raw-loader for .md imports).
 */
export const aboutMarkdown = `# 🐙 [About Octopus-Agent](https://github.com/octopus-agent/octopus-agent)
...
* **Skills & Tools**: With built-in and extensible skills and tools, Octopus can do almost anything.
...
If you have any questions or need help, please contact us at [support@octopus.dev](mailto:support@octopus.dev).
