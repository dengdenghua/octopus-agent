...
export const WebviewRenderer = forwardRef<WebviewHandle, Props>(function WebviewRenderer(
  {
    url,
    mode,
    refreshKey = 0,
  ...
  }, [onCanGoBackChange, onCanGoForwardChange, onError, onLoadingChange, onTitleUpdate]);
