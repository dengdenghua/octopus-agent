        ...
        <div className="ui-density-stack mx-auto flex w-full max-w-(--container-width-md) flex-col py-2">
          <section className="workspace-panel ui-density-panel flex flex-col gap-4 rounded-[1.75rem]">
            ...
            <div className="grid gap-3 md:grid-cols-2">
              <div className="workspace-panel-subtle ui-density-panel rounded-lg bg-gradient-to-br from-primary/5 to-transparent transition-all duration-200">
              ...
              <div className="workspace-panel-subtle ui-density-panel rounded-lg bg-gradient-to-br from-blue-500/5 to-transparent transition-all duration-200">
                <div className="mb-1 flex items-center gap-2 text-sm font-medium">
