...
function RealtimePageContent({
  ...
  const perspectiveExecutionEngine =
    perspectiveDisplayAgent?.capabilities?.execution_backend ===
    "codex_app_server"
      ? ("codex" as const)
      : ("octopus" as const);
  useEffect(() => {
    ...
    () => ({
      ...
      context: applyCoderModelProfileBoundary(
        mainPerspectiveAgentId,
        {
          ...
          execution_engine: perspectiveExecutionEngine,
        },
        perspectiveExecutionEngine,
      ),
  ...
  const hasSpecialUtilityPanel =
    showTeachRepeatPanel || (isOctopusAssistant && showAutomationPanel);
  ...
  const closeUnifiedRightPanel = useCallback(() => {
    ...
    if (isOctopusAssistant && showAutomationPanel) {
      setShowAutomationPanel(false);
      return;
    }
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="pt-3">
                          ...
                          <ChatInputBox
                            ...
                            executionEngine={perspectiveExecutionEngine}
                            mode={effectiveMode}
