...
const sections = [
  {
    title: "我们处理的数据",
    body: "Echo 可能处理你的登录标识、对话内容、任务上下文、上传文件、操作记录、浏览器会话状态、工作区配置和错误日志。实际范围取决于你启用的功能和部署方式。",
  },
  {
    title: "处理目的",
  ...
  {
    title: "安全措施",
    body: "Echo 与 EchoOS 会通过权限模式、工具确认、访问边界和运行日志降低误操作风险。你仍应避免在未确认目标的情况下输入密钥、验证码、身份证件、支付信息或其他敏感内容。",
  },
];
