...
const sections = [
  {
    title: "服务范围",
    body: "Echo 提供本地与云端协同的智能角色平台，用于对话、自动化、知识管理、团队协作和可复用技能编排。底层能力由 EchoOS 提供，具体可用范围会随账号权限、部署环境和已启用的插件而变化。",
  },
  {
    title: "账号与授权",
  ...
  {
    title: "使用边界",
    body: "请不要使用 Echo 进行违法、侵权、绕过访问控制、批量骚扰、恶意爬取或破坏系统稳定性的行为。涉及敏感数据、外部提交、删除、购买或权限变更时，应在执行前确认目标和影响。",
  },
  {
    title: "输出与责任",
