...
import "../../../../extensions/octopus-browser-relay/dom-actions.js";
...
function domActions(): DomActionApi {
  return (
    globalThis as typeof globalThis & {
      __OCTOPUS_DOM_ACTIONS__: DomActionApi;
    }
  ).__OCTOPUS_DOM_ACTIONS__;
}
...
describe("Chrome relay DOM actions", () => {
  test("updates an actual React controlled input", async () => {
    ...
    expect(screen.getByLabelText("Query")).toHaveValue("octopus");
    expect(screen.getByTestId("mirror")).toHaveTextContent("octopus");
  });
