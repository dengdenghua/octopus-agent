...
// (~/.octopus/commands/) + project-local entries; this just
...
export type SlashCommand =
  components["schemas"]["SlashCommandWire"];

export async function listSlashCommands(): Promise<{ commands: SlashCommand[] }> {
