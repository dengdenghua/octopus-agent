...
export const koKR: Translations = {
  ...
  chatInputBox: {
    ...
    maxSearches: "최대 검색 수",
    executionModeLabel: "실행 방식",
    discussionOnly: "토론만",
    discussionOnlyDesc: "도구나 작업을 실행하지 않고 아이디어만 논의합니다.",
  ...
  createProjectDialog: {
    ...
    defaultAssistantHint:
      "프로젝트 생성 후 멤버를 추가하거나 초대할 수 있습니다.",
  ...
  sidebar: {
    ...
    openAgentHud: "프로필 보기",
    agentProfileAction: "프로필",
    agentRoleSummary: {
      general: "업무 총괄",
      coder: "소프트웨어 개발",
      desktop_operator: "데스크톱 자동화",
      vibe_selling: "애니메이션 제작",
      ecommerce_mind: "해외 전자상거래",
      market_researcher: "투자 연구",
      aoi: "학술 연구",
      admin: "시스템 관리",
    },
    openAgentHudFor: (name: string) => `${name}의 프로필 보기`,
    ...
    expandWorkbench: "워크벤치 확장",
    restoreWorkbenchSplit: "분할 보기 복원",
    compactComposer: "입력창 접기",
    showComposer: "대화 계속",
  ...
  toolApproval: {
    ...
    rejected: "Rejected",
    tools: {
      project_initiation: "프로젝트 제안 및 팀 구성",
      project_acceptance: "단계별 결과물 검수",
      project_phase: "단계 실행 및 팀 구성",
      project_budget: "프로젝트 예산 변경",
      bash: "명령 실행",
      write_file: "파일 쓰기",
      str_replace: "파일 편집",
      git_commit: "커밋",
  ...
  settings: {
    ...
    evolution: {
      ...
      gepaDryRunHint:
        "💡 GEPA가 dry-run 상태입니다. OCTOPUS_GEPA_AUTO_APPLY=1로 설정해야 실제로 recipe 가중치가 업데이트됩니다.",
      ...
      camouflageDisabledHint:
        "⚙️ OCTOPUS_CAMOUFLAGE_ENABLED=1로 설정하여 활성화 · LLM 호출에 실제 비용이 들므로 기본값은 OFF입니다.",
    ...
    appearance: {
      ...
      paletteTitle: "색상 팔레트",
      paletteDescription: "중성 배경에 섬세한 색상으로 나만의 분위기를.",
      paletteRose: "벚꽃 핑크",
      paletteRoseDescription: "부드러운 벚꽃 핑크와 밀크 화이트.",
      paletteSteel: "클래식 블루",
      paletteSteelDescription: "깔끔하고 선명한 블루.",
      paletteEmerald: "버터크림",
      paletteEmeraldDescription: "따뜻하고 밝은 크림 옐로.",
      paletteViolet: "라일락",
      paletteVioletDescription: "몽환적이고 부드러운 연보라.",
      paletteAmber: "내추럴 티타늄",
      paletteAmberDescription: "따뜻하고 절제된 토프.",
      paletteTeal: "그래파이트",
      paletteTealDescription: "깊고 차분한 그래파이트.",
      paletteApricot: "피치",
      paletteApricotDescription: "달콤하고 따뜻한 피치 색감.",
      paletteMint: "실버 미스트",
      paletteMintDescription: "가볍고 깨끗한 실버 그레이.",
      paletteGroupSoft: "파스텔",
      paletteGroupDeep: "클래식",
  ...
  browser: {
    ...
    webviewTab: {
      ...
      settingNames: ["웹 검색", "데스크톱 편집", "홈으로", "레이아웃 초기화"],
      settingDescs: [
        "검색창에서 검색 엔진 선택",
        "아이콘 및 데스크톱 콘텐츠 정리",
        "현재 탭에서 홈페이지 열기",
        "확인 후 아이콘 순서, Dock 및 배경 초기화",
      ],
  ...
  collab: {
    ...
    mobileJoin: {
      title: "휴대폰 연결",
      description:
        "휴대폰에 octopus-mobile을 설치하고, 코드를 스캔하거나 붙여넣어 참여하세요(동일 Wi-Fi 필요)",
  ...
  accountSettings: {
    ...
    localAccountDescription:
      "현재 배포 환경에 접근하는 계정입니다. 클라우드 프로필 편집과 외부 계정 연결은 제공되지 않습니다.",
    localPrivacyDescription:
      "이 배포 환경은 클라우드 개인정보 설정을 제공하지 않습니다. 데이터 처리는 연결한 모델과 플러그인에 따라 달라지며 해당 설정에서 확인할 수 있습니다.",
    privacyUnavailable:
      "개인정보 설정을 읽지 못했습니다. 다시 시도한 후 변경하세요.",
  ...
  swarmPanel: {
    ...
    panelStatusPending: "대기 중",
    panelStatusRunning: "실행 중",
    panelStatusCompleted: "완료",
    panelStatusFailed: "실패",
    statTotal: "전체 작업",
    statCapacity: "범위",
    statRunning: "실행 중",
    statCompleted: "완료",
  ...
  observabilityPage: {
    ...
    runReviewStatusRunning: "실행 중",
    runReviewStatusDone: "정산됨",
