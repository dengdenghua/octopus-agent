...
export const enUS: Translations = {
  ...
  chatInputBox: {
    ...
    executionModeLabel: "Response mode",
    discussionOnly: "Discussion only",
    discussionOnlyDesc:
      "Discuss ideas without running tools or taking actions.",
  ...
  createProjectDialog: {
    ...
    defaultAssistantHint:
      "Add members or invite people after creating the project.",
  ...
  sidebar: {
    ...
    openAgentHud: "View profile",
    agentProfileAction: "Profile",
    agentRoleSummary: {
      general: "Office coordination",
      coder: "Software development",
      desktop_operator: "Desktop automation",
      vibe_selling: "Animated storytelling",
      ecommerce_mind: "Cross-border commerce",
      market_researcher: "Investment research",
      aoi: "Academic research",
      admin: "System administration",
    },
    openAgentHudFor: (name: string) => `View ${name}'s profile`,
    ...
    restoreWorkbenchSplit: "Restore split view",
    compactComposer: "Collapse composer",
    showComposer: "Continue conversation",
  ...
  toolApproval: {
    ...
    rejected: "Rejected",
    tools: {
      project_initiation: "Project proposal and staffing",
      project_acceptance: "Milestone delivery acceptance",
      project_phase: "Phase execution and staffing",
      project_budget: "Project budget adjustment",
      bash: "Run command",
  ...
  settings: {
    ...
    appearance: {
      ...
      paletteDescription:
        "Neutral surfaces. Considered accents. Find your signature color.",
      paletteRose: "Sakura Pink",
      paletteRoseDescription: "Soft blossom pink with airy ivory.",
      paletteSteel: "Classic Blue",
      paletteSteelDescription: "Clear blue on clean silver-white.",
      paletteEmerald: "Buttercream",
      paletteEmeraldDescription: "Warm butter yellow, soft and bright.",
      paletteViolet: "Lilac",
      paletteVioletDescription: "Soft lilac with a dreamy touch.",
      paletteAmber: "Natural Titanium",
      paletteAmberDescription: "Warm taupe, subtle and restrained.",
      paletteTeal: "Graphite",
      paletteTealDescription: "Deep graphite, simple and composed.",
      paletteApricot: "Peach",
      paletteApricotDescription: "Sweet peach, warm and lively.",
      paletteMint: "Silver Mist",
      paletteMintDescription: "Neutral silver grey, light and pure.",
      paletteGroupSoft: "Pastels",
      paletteGroupDeep: "Classic",
...
6. The final report should only merge results from each platform, deduplicate, mark conflicts, and suggest next steps.`,
    ...
    webviewTab: {
      ...
      settingDescs: [
        "Focus search and choose a search engine",
        "Arrange desktop icons and content",
        "Open the browser home page in this tab",
        "Restore default icon order, dock and background after confirmation",
      ],
  ...
  accountSettings: {
    ...
    localAccountDescription:
      "This account accesses the current deployment. Cloud profile editing and third-party account linking are unavailable.",
    localPrivacyDescription:
      "This deployment does not provide cloud privacy preferences. Data handling depends on the models and plugins you connect; review their settings.",
    privacyUnavailable:
      "Privacy settings could not be read. Retry before making changes.",
  ...
  store: {
    ...
    installExpertTitle: "Add to my roles",
    ...
    addExpert: "Add",
    addingExpert: "Working…",
    startExpertChat: "Start chat",
    manageExpert: "More role actions",
    removeExpert: "Remove role",
    removeExpertTitle: (name: string) => `Remove ${name}?`,
    removeExpertDescription: "Remove this expert and its local configuration from your roles. You can add it again from the catalog.",
    removeExpertSuccess: (name: string) => `Removed ${name}`,
    removeExpertFailed: "Could not remove role. Try again.",
    localExpertNotFound: "Could not uniquely identify the local role. Refresh and try again.",
    detailProfession: "Field",
    detailQuickPrompts: "Quick prompts",
    detailTags: "Tags",
    detailDescription: "About",
    detailInstall: "Add to my roles",
    detailInstalled: "Added",
    loadMore: "Load more",
  ...
  storage: {
    ...
    service: {
      ...
      notFound:
        "octopus-storage was not found. Install the local knowledge base service or set OCTOPUS_STORAGE_CMD, then try again.",
      startFailed:
