...
6. The final report should only merge results from each platform, deduplicate, mark conflicts, and suggest next steps.`,
  ...
  intelligence: {
    ...
    configuredEmptyDescription: "Choose a template or ask an Agent to create one in chat.",
    ...
    historyEmptyDescription: "Run results will appear here after a task executes.",
  },
