...
export const jaJP: Translations = {
  ...
  chatInputBox: {
    ...
    discussionOnly: "相談のみ",
    discussionOnlyDesc: "ツールや操作を実行せずにアイデアを話し合います。",
  ...
  sidebar: {
    ...
    openAgentHud: "プロフィールを見る",
    agentProfileAction: "詳細",
    agentRoleSummary: {
      general: "業務統括",
      coder: "ソフトウェア開発",
      desktop_operator: "デスクトップ自動化",
      vibe_selling: "アニメ制作",
      ecommerce_mind: "越境EC",
      market_researcher: "投資調査",
      aoi: "学術研究",
      admin: "システム管理",
    },
    openAgentHudFor: (name: string) => `${name} のプロフィールを見る`,
    ...
    expandWorkbench: "ワークベンチを拡大",
    restoreWorkbenchSplit: "分割表示に戻す",
    compactComposer: "入力欄を折りたたむ",
    showComposer: "会話を続ける",
  ...
  browserSettings: {
    ...
    compareInstallExt: "はい",
    compareInstallCdp: "いいえ",
  ...
  toolApproval: {
    ...
    rejected: "Rejected",
    tools: {
      project_initiation: "プロジェクト提案とチーム編成",
      project_acceptance: "成果物の検収",
      project_phase: "フェーズ実行とチーム編成",
      project_budget: "予算の変更",
      bash: "コマンド実行",
      write_file: "ファイル書き込み",
      str_replace: "ファイル編集",
      git_commit: "コミット",
  ...
  settings: {
    ...
    evolution: {
      ...
      gepaDryRunHint:
        "💡 GEPA は dry-run 中です。OCTOPUS_GEPA_AUTO_APPLY=1 を設定すると、実際に recipe weights が更新されます。",
      notGenerated: "未生成",
      camouflageTitle: "プロンプト進化（モデル駆動）",
      camouflageDescription:
        "PromptEvolver が失敗例を分析し、新しいプロンプトバリアントを自動提案します。",
      camouflageDisabledHint:
        "⚙️ OCTOPUS_CAMOUFLAGE_ENABLED=1 を設定して有効化 · LLM 呼び出しには実際のコストがかかるためデフォルトは OFF です。",
    ...
    appearance: {
      ...
      paletteTitle: "配色スタイル",
      paletteDescription: "ニュートラルな背景に、さりげない彩りを。",
      paletteRose: "さくらピンク",
      paletteRoseDescription: "桜色に軽やかなミルクホワイト。",
      paletteSteel: "クラシックブルー",
      paletteSteelDescription: "澄んだ青のアクセント。",
      paletteEmerald: "バタークリーム",
      paletteEmeraldDescription: "柔らかく明るいクリームイエロー。",
      paletteViolet: "ライラック",
      paletteVioletDescription: "夢見るような柔らかい紫。",
      paletteAmber: "ナチュラルチタン",
      paletteAmberDescription: "温かみのある控えめなトープ。",
      paletteTeal: "グラファイト",
      paletteTealDescription: "深く落ち着いたグラファイト。",
      paletteApricot: "ピーチ",
      paletteApricotDescription: "甘く温かなピーチカラー。",
      paletteMint: "シルバーミスト",
      paletteMintDescription: "軽やかなシルバーグレー。",
      paletteGroupSoft: "パステル",
      paletteGroupDeep: "クラシック",
      paletteCustom: "カスタム",
...
6. 最終レポートは各プラットフォームの結果を統合し、重複を除去し、矛盾をマークし、次のステップを提案するのみとする。`,
  ...
  collab: {
    ...
    mobileJoin: {
      title: "モバイルを接続",
      description:
        "スマートフォンに octopus-mobile をインストールし、スキャンまたはコードを貼り付けて参加（同一 Wi-Fi 必須）",
  ...
  accountSettings: {
    ...
    localAccountDescription:
      "このアカウントは現在の環境へのアクセスに使用します。クラウドプロフィールの編集と外部アカウントの連携は利用できません。",
    localPrivacyDescription:
      "この環境にはクラウドのプライバシー設定がありません。データの扱いは接続するモデルやプラグインによって異なります。各設定をご確認ください。",
    privacyUnavailable:
      "プライバシー設定を読み取れませんでした。再試行してから変更してください。",
  ...
  swarmPanel: {
    ...
    panelStatusPending: "待機中",
    panelStatusRunning: "実行中",
    panelStatusCompleted: "完了",
    panelStatusFailed: "失敗",
    statTotal: "総タスク",
    statCapacity: "範囲",
    statRunning: "実行中",
    statCompleted: "完了",
  ...
  observabilityPage: {
    ...
    eventActionFile: "ファイル",
    eventArtifact: "成果物",
    eventArtifactScreenshot: "スクリーンショット",
    eventSuccess: "成功",
    eventFailure: "失敗",
    ...
    runReviewRuns: "実行",
    runReviewRunning: "実行中",
    runReviewErrors: "エラー",
    runReviewTokens: "トークン",
    runReviewCost: "コスト",
    runReviewEmpty: "まだ実行イベントがありません",
    runReviewEmptyHint:
      "リアルタイム / コードタスクを開始してください。ジャーナルイベント到着後に振り返りカードが自動生成されます。",
    runReviewStatusRunning: "実行中",
    runReviewStatusDone: "完了",
