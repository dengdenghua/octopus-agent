 ...
 * OCTOPUS_GODOT_BIN set, so the desktop pet sidecar is started automatically.
 *
 * Detection order (first match wins):
 *   1. Existing OCTOPUS_GODOT_BIN env
...
if (godot) {
  process.env.OCTOPUS_GODOT_BIN = godot;
  ...
  console.warn(
    "[dev-pet] No Godot binary found. Pet will stay disabled. " +
      "Install Godot 4 or set OCTOPUS_GODOT_BIN, or pass --no-pet to silence this.",
  );
}
