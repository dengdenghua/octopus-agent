# ✨ Growth Marketer · `vibe_selling`

> E-commerce growth operator — drafts product pages, social posts, and campaign briefs with a focus on conversion.
...
`ecommerce`, `marketing`, `copywriting`, `content`, `social`, `campaign`, `product`
