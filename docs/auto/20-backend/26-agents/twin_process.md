---
type: "Agent"
title: "🔩 工艺工程师分身 · `twin_process`"
description: "代表工艺工程师的数位分身:工序参数/SOP/改善建议等文档侧闭环,现场调机与首件确认交给真人,AI 替代不了真实产线工艺。"
tags: ["backend", "agents"]
tier: "standard"
---
# 🔩 工艺工程师分身 · `twin_process`

> 代表工艺工程师的数位分身:工序参数/SOP/改善建议等文档侧闭环,现场调机与首件确认交给真人,AI 替代不了真实产线工艺。

**Agent dir**: `agents/twin_process/`
...
- **Source**: octopus digital-twin(human-role) · process
