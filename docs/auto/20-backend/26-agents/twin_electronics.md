---
type: "Agent"
title: "⚡ 电子工程师分身 · `twin_electronics`"
description: "代表电子工程师的数位分身:器件选型/参考设计/测试记录等文档侧闭环,实测验证交给真人,AI 替代不了真实电路调试。"
tags: ["backend", "agents"]
tier: "standard"
---
# ⚡ 电子工程师分身 · `twin_electronics`

> 代表电子工程师的数位分身:器件选型/参考设计/测试记录等文档侧闭环,实测验证交给真人,AI 替代不了真实电路调试。

**Agent dir**: `agents/twin_electronics/`
...
- **Source**: octopus digital-twin(human-role) · electronics
