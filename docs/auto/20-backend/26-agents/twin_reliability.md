---
type: "Agent"
title: "🕐 可靠性工程师分身 · `twin_reliability`"
description: "代表可靠性工程师的数位分身:老化/跌落/温湿度测试计划等文档侧闭环,真实环境实测交给真人,AI 替代不了真实老化验证。"
tags: ["backend", "agents"]
tier: "standard"
---
# 🕐 可靠性工程师分身 · `twin_reliability`

> 代表可靠性工程师的数位分身:老化/跌落/温湿度测试计划等文档侧闭环,真实环境实测交给真人,AI 替代不了真实老化验证。

**Agent dir**: `agents/twin_reliability/`
...
- **Source**: octopus digital-twin(human-role) · reliability
