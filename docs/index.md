...
6. [Legacy Local CLI Partners](guide/local-cli-partners.md): migration boundary for removed automatic CLI discovery; use Kane's embedded Codex engine or the OpenCode Zen API plugin instead.
