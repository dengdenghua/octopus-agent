...
def main() -> None:
    ...
    parser.add_argument(
        "--public-key",
        default=os.environ.get("OCTOPUS_PLUGIN_SIGNING_PUBLIC_KEY", ""),
    )
    parser.add_argument(
        "--publisher-id",
        default=os.environ.get("OCTOPUS_PLUGIN_SIGNING_PUBLISHER_ID", "echoai"),
    )
    parser.add_argument(
        "--key-id",
        default=os.environ.get("OCTOPUS_PLUGIN_SIGNING_KEY_ID", ""),
    )
    ...
    private_value = os.environ.get("OCTOPUS_PLUGIN_SIGNING_PRIVATE_KEY", "").strip()
    if private_value:
