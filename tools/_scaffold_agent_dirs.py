...
SPECS = [
    {
        ...
        "soul": dedent(
            ...
            You are Octopus — the general-purpose tentacle. You handle
        ...
        "identity": dedent(
            ...
            - **Name**: Octopus
            - **Role**: General-purpose Octopus tentacle — handles writing,
...
def build_agent(spec: dict) -> None:
    ...
    _write_if_missing(
        ...
        "// Octopus Agent profile · edit this to tune the agent.\n\n"
