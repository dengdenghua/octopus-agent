#!/usr/bin/env python3
"""Install forked WorkBuddy experts/skills into the local octopus skill hub.

Populates ~/.octopus/skills/ (SKILL.md + meta.json per skill) and rebuilds
~/.octopus/skills/registry.json so `python -m runtime skills list|search|info`
...
def default_skills_dir() -> Path:
    return Path.home() / ".octopus" / "skills"
