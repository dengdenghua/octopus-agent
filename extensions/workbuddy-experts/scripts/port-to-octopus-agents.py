#!/usr/bin/env python3
"""Port forked WorkBuddy experts into octopus-agent's agents/ store format.
...
octopus agent tree:
    ...
    └── skills/                # copied plugin skills (also mirrored to ~/.octopus/skills)

Usage:
  python3 scripts/port-to-octopus-agents.py \
...
def main() -> int:
    ...
    ap.add_argument("--skills-hub", default=str(Path.home() / ".octopus" / "skills"))
